<div class="art-layout-cell art-sidebar2" style="float:right;">
  <div class="art-block clearfix">
    <div class="art-blockcontent">
      ...
      document.write("<div id='advertiser-7'></div>");

      function proceed() {
        var url =
          'http://eubanner.com/ads/advertiser/7/getRandomBanner/250/250';
        $.get(url, function(html) {
          $('#advertiser-7').html(html);
        });
      }
      </script> --}}
      <div id="advertiser-7"></div>
    </div>
  </div>
  <div class="art-block clearfix">
    <div class="art-blockcontent">
  ...
  <div class="art-block clearfix">
    <div class="art-blockcontent">
      <a href="/index.php?option=com_adsmanager&amp;task=write&amp;Itemid=691&amp;lang=en"><img src="{{asset('images/kataxorisi_neas_aggelias_en.png')}}" alt="kataxorisi neas aggelias en"
          width="240" height="41"></a>
          <img src="{{asset('images/right_ad_en_new.png')}}"
        alt="right ad en new" width="235" height="175" hidden="" style="display: none !important;">
      </div>
  </div>
  <div class="art-block clearfix">
    <div class="art-blockcontent">
  ...
  <div class="art-block clearfix">
    <div class="art-blockcontent">
      <a href="http://www.anakainisi-katoikias.gr/" target="_blank"><img src="images/diadimisteite_edo_3_en.png" alt="diadimisteite edo 3 en"
