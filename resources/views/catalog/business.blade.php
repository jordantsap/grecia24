												...
												<div id="sobi2outer">
													...
													<div class="dynamic-tab-pane-control tab-page" id="TabsPane">
														<div class="tab-row">
															...
															<h2 class="tab">
																<a href="#Tab2">Φωτογραφίες</a>
															</h2>
															<h2 class="tab">
																<a href="#Tab3">Χάρτης</a>
															</h2>
														</div>
														...
														<div class="tab-page" id="Tab2" style="display: block;">
															{{-- <script type="text/javascript">
																SobiTabPane.addTabPage(document.getElementById(
																	"Tab2"));
															</script> --}}
											        ...
											        @endif
														...
														<div class="tab-page" id="Tab3" style="display: block;">
															{{-- <script type="text/javascript">
																SobiTabPane.addTabPage(document.getElementById(
																	"Tab3"));
															</script> --}}
																			...
																			<div style="z-index: 1; position: absolute; left: 50%; top: 50%; width: 100%; transform: translate(0px, 0px);">
																				...
																				<div style="position: absolute; left: 0px; top: 0px; z-index: 103; width: 100%;">
																					...
																					<div style="width: 27px; height: 43px; overflow: hidden; position: absolute; left: -14px; top: -43px; z-index: 0;"><img alt=""
																						  ...
																						  style="position: absolute; left: 0px; top: 0px; width: 27px; height: 43px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;"></div>
																				</div>
...
@section('extra-js')
	...
	        .animate({scrollTop: targetOffset}, 20000);
					.animate({scrollBottom: targetOffset}, 20000);
