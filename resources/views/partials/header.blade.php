                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <div id="languages" class="col-xs-3" style="">
                      <div id="jflanguageselection">
                          <div class="rawimages">
                              <span><a href="ru"><img src="{{asset('images/flags/ru.gif')}}" alt="Russian" title="Russian"></a></span>
                              <span>
                                  <a href="el">
                                      <img src="{{asset('images/flags/el.gif')}}" alt="Greek" title="Greek"></a></span>
                              <span id="active_language"><a href="en"><img src="{{asset('images/flags/en.gif')}}" alt="English" title="English"></a></span>
                              <span><a href="bg"><img src="{{asset('images/flags/bg.gif')}}" alt="Bulgarian" title="Bulgarian"></a></span>
                          </div>
                      </div>
                  </div>
                    <div id="menu" class="col-xs-12" style="">
                      <ul class="art-hmenu" style="margin-top:20px;">
                          <li id="current" class="active item1"><a href="{{url('/')}}" class=" active">Home</a></li>
